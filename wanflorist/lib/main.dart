...
void main() {
  ...
  while (jalan) {
    ...
    switch (pilihan) {
      case '1':
        menuKatalog(ui, katalog);
        break;
      case '2':
        menuPesanan(ui, katalog, antrian);
        break;
      case '3':
...
void menuKatalog(ConsoleUI ui, KatalogProduk katalog) {
  bool kembali = false;
  while (!kembali) {
    ...
    switch (pilihan) {
      ...
      case '6':
        ...
        katalog.editProduk(idEdit, namaBaru, kategoriBaru, hargaBaru, stokBaru);
        ui.tungguEnter();
        break;
      case '0':
        kembali = true;
...
void menuPesanan(ConsoleUI ui, KatalogProduk katalog, AntrianPesanan antrian) {
  bool kembali = false;
  while (!kembali) {
